    ...
    <div class="bg-white flex flex-col">
        <div className="flex justify-between mb-4 px-5">
            <a
                ...
                class="bg-blue-500 px-4 py-2 rounded text-white float-right"
            >
                Buat Pengajuan
            </a>
        </div>
        <div class="flex flex-row items-center justify-between px-5 mt-4">
            <select
                name="limit"
                id="limit"
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(limit,search,page){
                ...
                url: "{{ route('perjalanan-dinas.table') }}",
